...
def test_cli_status(tmp_path, monkeypatch):
    ...
    from michigram.cli import cmd_status
    import argparse
    config_dir = tmp_path / ".michigram"
...
def test_cli_memory_store_recall(tmp_path, monkeypatch, capsys):
    ...
    import michigram.core.config as cfg_mod
    ...
    import argparse
    from michigram.cli import cmd_memory
...
def test_cli_inject(tmp_path, monkeypatch, capsys):
    ...
    import argparse
    from michigram.cli import cmd_inject
